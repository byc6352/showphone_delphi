...
uses
  ...
  Vcl.Controls, Vcl.Forms, Vcl.Dialogs, Vcl.Menus, Vcl.ComCtrls, Vcl.OleCtrls,usound,
...
begin
  ...
  begin
    ...
    path:=ansistrings.AnsiRightStr(path,length(path)-i);
